...
public class AdminCategoryController {
	...
	public String create(RedirectAttributes redirectAttributes,
						@ModelAttribute @Validated CategoryRegisterForm categoryRegisterForm, BindingResult bindingResult) {
	...
	public String update(@PathVariable(name = "id") Integer id, RedirectAttributes redirectAttributes, 
						@ModelAttribute @Validated CategoryRegisterForm categoryRegisterForm, BindingResult bindingResult) 
	{
		...
		categoryService.updateCategory(categoryRegisterForm, category);
