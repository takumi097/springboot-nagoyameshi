...
public class StripeService {
	...
	//顧客（Customerオブジェクト）のデフォルトの支払い方法（paymentMethodオブジェクト）を取得する
	...
	//顧客の（Customerオブジェクト）のデフォルト支払い方法（PaymentMethodオブジェクト）のIdを取得
	...
	//サブスクリプション（Subscriptionオブジェクト）をキャンセルする
